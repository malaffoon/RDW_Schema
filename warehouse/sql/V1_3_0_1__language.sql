...
-- The code is ISO 639-2, lowercase. For some entries, there is no ISO 639-2 mapping
-- so an unofficial code was used; this is noted by comment.
-- The altcode is from CALPADS. Many of the entries do not have a CALPADS value.
