...
INSERT INTO exam_item (exam_id, item_natural_id, score, score_status, response) VALUES
  (1, '200-60347', 1, 'SCORED', 'D'),
  (1, '200-51719', 1, 'SCORED', 'B'),
  (1, '200-59217', 1, 'SCORED', 'D'),
  (1, '200-30901', 1, 'SCORED', 'C'),
  (1, '200-30899', 1, 'SCORED', 'B'),
  (1, '200-30891', 1, 'SCORED', '<itemResponse><response id="EBSR1"><value>A</value></response><response id="EBSR2"><value>D</value></response></itemResponse>'),
  (1, '200-32604', 1, 'SCORED', 'C'),
  (1, '200-58465', 1, 'SCORED', 'C,E'),
  (1, '200-43427', 1, 'SCORED', 'A'),
  (1, '200-43440', 1, 'SCORED', 'A'),
  (1, '200-54097', 1, 'SCORED', '<itemResponse><response id="1"><value>3</value><value>5</value></response></itemResponse>'),
  (1, '200-58401', 1, 'SCORED', '<itemResponse><response id="EBSR1"><value>C</value></response><response id="EBSR2"><value>A</value></response></itemResponse>'),
  (1, '200-43423', 1, 'SCORED', 'E, F'),
  (1, '200-41656', 1, 'SCORED', 'C'),
  (1, '200-35901', 1, 'SCORED', '<itemResponse><response id="EBSR1"><value>B</value></response><response id="EBSR2"><value>A</value></response></itemResponse>'),
  (1, '200-35903', 1, 'SCORED', 'C'),
  (1, '200-35905', 1, 'SCORED', '<itemResponse><response id="RESPONSE"><value>1 a</value><value>2 b</value><value>3 b</value><value>4 b</value><value>5 a</value><value>6 a</value></response></itemResponse>'),
  (1, '200-63424', 1, 'SCORED', 'B'),
  (1, '200-30153', 1, 'SCORED', 'B'),
  (1, '200-26487', 0, 'SCORED', 'D'),
  (1, '200-27817', 0, 'SCORED', '<itemResponse><response id="1"><value>3</value></response></itemResponse>'),
  (1, '200-26485', 1, 'SCORED', '<itemResponse><response id="EBSR1"><value>C</value></response><response id="EBSR2"><value>C</value></response></itemResponse>'),
  (1, '200-26475', 1, 'SCORED', '<itemResponse><response id="1"><value>1</value><value>2</value></response></itemResponse>'),
  (1, '200-26475', 1, 'SCORED', 'A,E'),
  (1, '200-26483', 1, 'SCORED', 'That the water-scorpion inhales air in an odd way. The source says,"You may catch him too when he comes up to get air. This he does in a very funny way."'),
  (1, '200-26465', 1, 'SCORED', 'A'),
  (1, '200-33850', 1, 'SCORED', '<itemResponse><response id="RESPONSE"><value>1 a</value><value>2 b</value><value>3 a</value><value>4 a</value></response></itemResponse>'),
  (1, '200-33848', 1, 'SCORED', 'D'),
  (1, '200-33846', 1, 'SCORED', '<itemResponse><response id="EBSR1"><value>A</value></response><response id="EBSR2"><value>D</value></response></itemResponse>'),
  ...
  (1, '200-28209', 1, 'SCORED', '<itemResponse><response id="EBSR1"><value>D</value></response><response id="EBSR2"><value>D</value></response></itemResponse>'),
  (1, '200-28203', 0, 'SCORED', '<itemResponse><response id="1"><value>2</value><value>3</value></response></itemResponse>'),
  (1, '200-28215', 0, 'SCORED', 'C'),
  (1, '200-28205', 0, 'SCORED', '<itemResponse><response id="EBSR1"><value>D</value></response><response id="EBSR2"><value>D</value></response></itemResponse>'),
  (1, '200-30149', 1, 'SCORED', '<itemResponse><response id="1"><value>1</value><value>4</value></response></itemResponse>'),
  (1, '200-32372', 0, 'SCORED', 'C,F'),
  (1, '200-41676', 1, 'SCORED', 'C'),
  (1, '200-54456', 1, 'SCORED', 'A'),
  (1, '200-54466', 1, 'SCORED', 'C'),
  (1, '200-54458', 0, 'SCORED', 'B'),
  (1, '200-54452', 2, 'SCORED', 'The theme of the text is to always help someone who is in need of help. In the text it says,"She thought quickly, then decided it wouldn''t take her long to search for the lamb."'),
